...
<body>
    ...
    <div class="container">
        ...
        <form action="/entrypj/create_event" method="POST" enctype="multipart/form-data">
            ...
            <div class="top-section">
                ...
                <div class="info-col">
                    <div class="form-group">
                        ...
                        <input type="text" require name="event_name" placeholder="ระบุชื่อกิจกรรมของคุณ..." required>
                    </div>
            ...
            <div class="middle-row">
                <div class="form-group">
                    <label>สถานที่</label>
                    <input type="text" require name="location" placeholder="เช่น ห้องประชุม 1, หอประชุมใหญ่...">
                </div>
                <div class="form-group">
                    <label>จำนวนที่รับ (คน)</label>
                    <input type="number" required min="1" step="1" name="max_participants" placeholder="ใส่ตัวเลข">
                </div>
            </div>
            ...
            <div class="date-row">
                <div class="form-group">
                    ...
                    <input type="datetime-local" require name="start_date" required>
                </div>
                <div class="form-group">
                    <label>วันจบงาน</label>
                    <input type="datetime-local" require name="end_date" required>
                </div>
            </div>
