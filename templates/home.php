...
// เติม __DIR__ ป้องกัน Error 500
        ...
        <div class="event-grid">
            <?php foreach ($events as $event): ?>
                ...
                <div class="event-card">
                    <img src="<?php echo htmlspecialchars($cover_image); ?>" alt="Event Image" class="event-img">
                   ...
                   <a href="/event_detail?id=<?php echo $event['event_id']; ?>" style="display: inline-block; padding: 8px 15px; background: #3498db; color: white; text-decoration: none; border-radius: 5px; font-size: 0.9em; margin-top: 10px;">
    🔍 ดูรายละเอียด
</a>
