...
<body>
    ...
    <div class="container">
        <div class="header-action">
            ...
            <a href="/entrypj/create_event.php" class="btn-create">➕ สร้างกิจกรรมใหม่</a>
        </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="action-buttons" style="justify-content: center;">
                                <a href="/entrypj/edit_event.php?id=<?php echo $event['event_id']; ?>" class="btn-action btn-edit">✏️ แก้ไข</a>
                    ...
                    <tr>
                        <td colspan="5">
                            <div class="empty-state">
                                ...
                                <a href="/entrypj/create_event.php" style="color: #3498db; text-decoration: none; font-weight: bold;">คลิกที่นี่เพื่อสร้างกิจกรรมแรกของคุณ</a>
                            </div>
                        </td>
                    </tr>
                <?php endif; ?>
